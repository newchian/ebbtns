...
<head>
    ...
    <base target="_blank">
    <title>测测-聊天室</title>
    <link href="chatr/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
    <link rel="stylesheet" href="chatr/css/chat.css">
    <script src="chatr/js/jquery-1.9.1.min.js"></script>

    <script type="text/javascript">
        <%
            String suser = session.getAttribute("suser")+"";
        %>
        var self = '<%= suser %>';
    </script>
    <script type="text/javascript" src="chatr/js/ws.js"></script>
</head>
...
<img style="width:100%;height:100%" src="chatr/img/chat_bg.jpg">
        ...
        <div class="abs cover pnl-body" id="pnlBody">
            <div class="abs cover pnl-left">
                ...
                <div class="abs bottom pnl-text">
                    ...
                    <div class="pnl-support" id="copyright"><a href="http://www.cece.cn">测测,版本所有</a></div>
                </div>
            </div>
